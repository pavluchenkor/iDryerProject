...
# Проект устройства и документация

Этот репозиторий содержит прошивку и дизайн устройства, а также документацию и гербер-файлы.

## Включает:

- Прошивку для устройства.
- Дизайн корпуса с 3D-моделями.
- Производственные файлы PCB.
- BOM (Bill of Materials - Список компонентов).
- Описание функционала и инструкции по использованию.
- Техническую документацию.

Для энтузиастов 3D-печати, разработчиков и инженеров. Добро пожаловать!
